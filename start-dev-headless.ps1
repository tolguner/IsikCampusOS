...
Start-Process -NoNewWindow -FilePath "powershell" -ArgumentList "-Command", ".\mvnw.cmd spring-boot:run -pl services/event-service > logs/event-service.live.log 2> logs/event-service.live.err.log"
