    ...
    <div className="theme-page min-h-screen flex flex-col relative overflow-hidden bg-[#060c24]">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[20%] -right-[10%] w-[50%] h-[50%] rounded-full blur-[120px] animate-float-reverse"
             style={{ background: 'radial-gradient(circle, var(--ambient-pink) 0%, transparent 70%)' }} />
        <div className="absolute -bottom-[20%] left-[20%] w-[60%] h-[60%] rounded-full blur-[120px] animate-float"
             style={{ background: 'radial-gradient(circle, var(--ambient-cyan) 0%, transparent 70%)' }} />
      </div>

      {/* Content wrapper */}
      <div className="relative z-10 flex flex-col flex-1">
        {/* Navbar */}
        <nav className="theme-nav relative z-50 mx-5 mt-5 px-6 py-3.5 rounded-3xl flex justify-between items-center"
          ...
          >
            ...
            <div>
              <span className="theme-text font-bold text-lg text-white">
          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="relative">
              ...
              {notificationsOpen && (
                <div className="theme-popover absolute right-0 top-full mt-3 w-80 rounded-2xl border border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden z-[100]"
                     style={{ backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}>
            ...
            {isAuthenticated && user && (
              <>
                <div className="w-px h-6 self-center mx-1" style={{ background: 'var(--divider-color)' }} />
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 top-full pt-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-[100]">
                    <div className="theme-popover w-52 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden border border-white/10"
                         style={{ backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}>
