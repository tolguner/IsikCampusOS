...
export const YETKI_GRUPLARI = {
  ...
  // CampusRide onayları: Yapı, Destek ve Ulaşım Hizmetleri Müdürlüğü
...
export const ROL_ETIKETLERI: Record<string, string> = {
  ...
  ROLE_RIDE_ADMIN: 'Yapı, Destek ve Ulaşım Hizmetleri Müdürlüğü',
  ROLE_BUILDING_SUPPORT_ADMIN: 'Yapı, Destek ve Ulaşım Hizmetleri Müdürlüğü',
