...
> **Not (yazım rehberi):** "SPA" kısaltması metinde iki farklı anlamda kullanılmaktadır: ön yüz bağlamında "Single Page Application", proje eşleştirme algoritması bağlamında "Student-Project Allocation". Karışıklığı önlemek için, tezde her bölümün ilk kullanımında kısaltmanın açılımı parantez içinde verilmelidir.
